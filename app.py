...
def probar_voz_web():
    """Servicio de la interfaz gráfica de la Consola del Oráculo (probar_voz.html) v7.0 Direct Toggle and Safe Canvas."""
...
def video_revelacion_web():
    """Servicio de la interfaz de revelación de carta en vídeo (video_revelacion.html) v1.3 (15s polling)."""
