...
$PROJ_DIR = (Get-Item "android_apk_project").FullName
$OUT_DIR = "$PROJ_DIR\out"
$ASSETS_DIR = "$PROJ_DIR\app\src\main\assets"
$UNALIGNED_APK = "$OUT_DIR\apk\app-unaligned.apk"
$FINAL_APK = (Join-Path (Get-Location) "CodigoCarta_Marco_Analogico.apk")

Write-Host "Iniciando compilacion de Codigo Carta Marco Analogico APK..." -ForegroundColor Cyan
